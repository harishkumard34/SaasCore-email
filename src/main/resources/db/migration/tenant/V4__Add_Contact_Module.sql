...
INSERT INTO modules (module_name, plural_name, singular_name, system_defined, is_disabled, table_name, created_time, modified_time)
VALUES ('Company', 'Companies', 'Company', TRUE, FALSE, '2',
        (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
        (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT);

-- Insert Products Module
INSERT INTO modules (module_name, plural_name, singular_name, system_defined, is_disabled, table_name, created_time, modified_time)
VALUES ('Product', 'Products', 'Product', TRUE, FALSE, '3',
        (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
        (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT);

-- Insert Sales Module
INSERT INTO modules (module_name, plural_name, singular_name, system_defined, is_disabled, table_name, created_time, modified_time)
VALUES ('Sales', 'Sales', 'Sales', TRUE, FALSE, '4',
        (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
        (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT);
...
BEGIN
    ...
    INSERT INTO sections (section_name, visibility, created_time, modified_time)
    VALUES
...
(layout_id_var, address_section_id_var, module_id_var, 2,
 ...
 (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT);
    ...
    VALUES
    ('First Name', 'stringColumn1', 1, 255, 1, 'First Name', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT),
    ('Last Name', 'stringColumn2', 1, 255, 1, 'Last Name', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT),
    ('Mail', 'stringColumn3', 4, 255, 5, 'Mail', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT),
    ('Phone', 'stringColumn4', 3, 15, 10, 'Phone', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT),
    ('Mobile', 'stringColumn5', 3, 15, 10, 'Mobile', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT);
    ...
    INSERT INTO fields (field_name, column_name, type, max_length, min_length, display_name, is_picklist, created_time, modified_time)
    VALUES
    ('Street', 'stringColumn6', 2, 255, 1, 'Street', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT),
    ('City', 'stringColumn7', 1, 100, 1, 'City', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT),
    ('District', 'stringColumn8', 1, 100, 1, 'District', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT),
    ('State', 'stringColumn9', 1, 100, 1, 'State', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT),
    ('Country', 'stringColumn10', 1, 100, 1, 'Country', FALSE,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT,
     (EXTRACT(EPOCH FROM CURRENT_TIMESTAMP) * 1000)::BIGINT);
